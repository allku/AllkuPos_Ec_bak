...
INSERT INTO resources(id, name, restype, content) VALUES('65', 'Printer.TicketPreview_A4', 0, $FILE{/com/openbravo/pos/templates/Printer.TicketPreview_A4.xml});
INSERT INTO resources(id, name, restype, content) VALUES('66', 'Printer.TicketRemote', 0, $FILE{/com/openbravo/pos/templates/Printer.TicketRemote.xml});
INSERT INTO resources(id, name, restype, content) VALUES('67', 'Printer.TicketTotal', 0, $FILE{/com/openbravo/pos/templates/Printer.TicketTotal.xml});

-- SCRIPTS
INSERT INTO resources(id, name, restype, content) VALUES('68', 'script.Keyboard', 0, $FILE{/com/openbravo/pos/templates/script.Keyboard.txt});
INSERT INTO resources(id, name, restype, content) VALUES('69', 'script.Linediscount', 0, $FILE{/com/openbravo/pos/templates/script.Linediscount.txt});
INSERT INTO resources(id, name, restype, content) VALUES('70', 'script.posapps', 0, $FILE{/com/openbravo/pos/templates/script.posapps.txt});
